...
public class ApprovalDetails_AA_BulkCancel_AdvanceRequests {
WebDriver driver;
	
	@Given("^Admin module, Approval module, Approval details page, Advance approval tab, bulk Cancel button and close button$")
	public void Admin_module_Approval_module_Approval_details_page_Advance_approval_tab_bulk_Cancel_button_and_close_button() throws Throwable {
	...
	public void Click_on_Approval_details_link_under_Approval_module_select_the_Advance_requests_click_on_Bulk_Cancel_button_and_click_on_Close_button() throws Throwable {
	...
	public void All_the_selected_Advance_requests_should_get_cancelled_and_confirmation_message_should_be_displayed() throws Throwable {
