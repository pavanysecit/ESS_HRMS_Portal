...
public class ApprovalDetails_LA_IndividualLeave_Cancel {
WebDriver driver;	
	
	@Given("^Admin module, Approval module, Approval details page, leave approval tab, Cancel button and close button$")
	public void Admin_module_Approval_module_Approval_details_page_leave_approval_tab_Cancel_button_and_close_button() throws Throwable {
	...
	public void Click_on_Approval_details_link_under_Approval_module_click_on_Cancel_button_and_click_on_Close_button() throws Throwable {
	    ...
	    driver.findElement(By.xpath("/html/body/div[2]/div/section[2]/div/section/div/div/div/div[1]/div/div[2]/div[4]/div/table/tbody/tr/td[11]/button[2]")).click();
	    Thread.sleep(4000);
	}

	@Then("^Leave request should get cancelled and confirmation message should be displayed$")
	public void Leave_request_should_get_cancelled_and_confirmation_message_should_be_displayed() throws Throwable {
	...
	@Then("^After cancellation, cancelled leave count should get added to the respective employee's leave balance$")
	public void After_cancellation_cancelled_leave_count_should_get_added_to_the_respective_employee_s_leave_balance() throws Throwable {
