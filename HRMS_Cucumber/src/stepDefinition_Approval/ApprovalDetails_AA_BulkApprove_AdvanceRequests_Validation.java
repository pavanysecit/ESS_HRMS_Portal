...
public class ApprovalDetails_AA_BulkApprove_AdvanceRequests_Validation {
WebDriver driver;
	
	@Given("^Admin module, Approval module, Approval details page, Advance approval tab, bulk Approve button and validation message$")
	public void Admin_module_Approval_module_Approval_details_page_Advance_approval_tab_bulk_Approve_button_and_validation_message() throws Throwable {
	...
	public void Click_on_Approval_details_link_under_Approval_module_dont_select_the_Advance_requests_and_click_on_Bulk_Approve_button() throws Throwable {
	...
	public void System_should_display_the_validation_message_for_not_selecting_the_advance_requests_and_clicking_on_bulk_approve_button() throws Throwable {
