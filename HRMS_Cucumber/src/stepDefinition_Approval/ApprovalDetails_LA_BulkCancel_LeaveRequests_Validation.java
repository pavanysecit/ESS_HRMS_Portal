...
public class ApprovalDetails_LA_BulkCancel_LeaveRequests_Validation {
WebDriver driver;
	
	@Given("^Admin module, Approval module, Approval details page, Leave approval tab, bulk Cancel button and validation message$")
	public void Admin_module_Approval_module_Approval_details_page_Leave_approval_tab_bulk_Cancel_button_and_validation_message() throws Throwable {
	...
	public void Click_on_Approval_details_link_under_Approval_module_dont_select_the_Leave_requests_and_click_on_Bulk_Cancel_button() throws Throwable {
	...
	public void System_should_display_the_validation_message_for_not_selecting_the_Leave_requests_and_clicking_on_bulk_Cancel_button() throws Throwable {
